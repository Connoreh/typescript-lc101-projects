...
//     let hoursToDestination: number = milesAway / speedMph;
...
// console.log(`${spaceShuttle.name} would take ${spaceShuttle.getDaysToLocation(kilometersToTheMoon)} days sto get to Mars`);
